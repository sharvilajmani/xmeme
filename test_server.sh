...
curl --location --request GET 'http://ec2-3-141-30-135.us-east-2.compute.amazonaws.com:8081/memes'


# Execute the POST /memes endpoint using curl

curl --location --request POST 'http://ec2-3-141-30-135.us-east-2.compute.amazonaws.com:8081/memes' --header 'Content-Type: application/json' --data-raw '{"name": "xyz","url": "abc.com","caption": "This is a meme"}'
...
curl --location --request GET 'ec2-3-141-30-135.us-east-2.compute.amazonaws.com:8081/swagger-ui/'